...
# === TÉLÉCHARGEMENT & EXTRACTION DES DONNÉES ===
# 👉 Remplace par l'ID du fichier ZIP (et pas un dossier Drive)
# Lien partagé : https://drive.google.com/file/d/TON_ID/view?usp=sharing
# On récupère l’ID du fichier, pas du dossier.
zip_url = 'https://drive.google.com/uc?id=1RSkc-YWG40FSBPJ4oWqOc75YrrPHVMex'
zip_output = 'SAE.zip'

# Téléchargement uniquement si pas encore fait
...
df_base = pd.read_csv("data/base_complete.csv", sep=';', encoding='ISO-8859-1')
df_crimes = pd.read_csv("data/base_délits2.csv", sep=';', encoding='ISO-8859-1')
df_diplomes = pd.read_csv("data/base_diplomes_formation.csv", sep=';', encoding='ISO-8859-1')
df_sante = pd.read_csv("data/equipements_sante2.csv", sep=';', encoding='ISO-8859-1')
